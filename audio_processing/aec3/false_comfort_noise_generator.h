...
#ifndef MODULES_AUDIO_PROCESSING_AEC3_FALSE_COMFORT_NOISE_GENERATOR_H_
#define MODULES_AUDIO_PROCESSING_AEC3_FALSE_COMFORT_NOISE_GENERATOR_H_
...
// Generates the false comfort noise.
class FalseComfortNoiseGenerator {
 public:
  FalseComfortNoiseGenerator(Aec3Optimization optimization,
                        size_t num_capture_channels);
  FalseComfortNoiseGenerator() = delete;
  ~FalseComfortNoiseGenerator();
  FalseComfortNoiseGenerator(const FalseComfortNoiseGenerator&) = delete;
