...
#ifndef MODULES_AUDIO_PROCESSING_AEC3_SCALED_COMFORT_NOISE_GENERATOR_H_
#define MODULES_AUDIO_PROCESSING_AEC3_SCALED_COMFORT_NOISE_GENERATOR_H_
...
// Generates the scaled comfort noise.
class ScaledComfortNoiseGenerator {
 public:
    ScaledComfortNoiseGenerator(Aec3Optimization optimization,
                        size_t num_capture_channels);
    ScaledComfortNoiseGenerator() = delete;
  ~ScaledComfortNoiseGenerator();
    ScaledComfortNoiseGenerator(const ScaledComfortNoiseGenerator&) = delete;
...
#endif  // MODULES_AUDIO_PROCESSING_AEC3_SCALED_COMFORT_NOISE_GENERATOR_H_
